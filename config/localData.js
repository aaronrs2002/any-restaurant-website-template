let config = [
      ...
      */
    {
        ...
        "media": [
            ...
            {
                "type": "html",
                "address": "<div><label>First Name: <input type='text' class='form-control' name='fname' placehodler='First Name' /></label><label>Last Name: <input type='text' class='form-control' name='lname' placehodler='Last Name' /></label><button type='button' class='btn btn-success form-control' >Submit</button></div>"
            },
            {
                "type": "html",
                "address": "<div class='col-md-12'><h3>Rich Text Available</h3><p>As long as you do not break your javascript \"string\", you can type whatever HTML you would like. Forms incluided, like I demonstrated above.</div>"
            },
            {
                "type": "map",
        ...
        "socialMedia": [
            {
                ...
                "theClass": "fab fa-linkedin",
                "title": "My Linkedin Profile"
            },
            {
                "link": "https://github.com/aaronrs2002",
                "theClass": "fab fa-github",
                "title": "My Open Source Library"
            },
            {
                "link": "https://www.youtube.com/@web-presence-developer",
                "theClass": "fab fa-youtube",
                "title": "Learn how to write web applications!"
            },
            {
                "link": "https://www.instagram.com/aaronrs2002/",
                "theClass": "fab fa-instagram",
                "title": "Payoff from a multimedia degree."
            },
            {
                "link": "https://aaronrs2002.github.io/task-master/?",
                "theClass": "fas fa-network-wired",
                "title": "Networked serverless web apps for Workflow Management and Accounting"
            },
            {
                "link": "    https://aaronrs2002.github.io/rss-aggregator/?",
